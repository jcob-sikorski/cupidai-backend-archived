...
default_workflow = {
    "206": {
      "inputs": {
        ...
        "negative": basic_neg_text_prompt,
    ...
    "229": {
      "inputs": {
        ...
        "steps": basic_sampling_steps,
        "cfg": basic_cfg_scale,
        "sampler_name": basic_sampler_method,
        "scheduler": "normal",
        "denoise": basic_denoise,
        "preview_method": "auto",
        "vae_decode": "true",
        "model": [
          "206",
